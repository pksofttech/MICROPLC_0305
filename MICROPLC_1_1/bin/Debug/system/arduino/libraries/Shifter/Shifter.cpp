...
// Constructor
Shifter595::Shifter(int SER_Pin, int RCLK_Pin, int SRCLK_Pin, int Number_of_Registers){	
	_SER_Pin = SER_Pin;
	_RCLK_Pin = RCLK_Pin;
...
void Shifter595::setPin(int index, boolean val){
...
void Shifter595::setAll(boolean val){
