...
{
	public :
	TimerOn(unsigned int timerPeriod);
	unsigned int stratus();
	void process();
	private :
...
{
	public :
	TimerOff(unsigned int timerPeriod);
	unsigned int stratus();
	void process();
	private :
	unsigned long _timerPeriod;
...
{
	public :
	TimerCycle(unsigned int timerPeriodOn,unsigned int timerPeriodOff);
	unsigned int stratus();
	void process();
	private :
	unsigned long _timerPeriodOn;
	unsigned long _timerPeriodOff;
	unsigned long _timerStateOn;
	unsigned long _timerStateOff;
	unsigned int  _st;
};
class Shift
{
